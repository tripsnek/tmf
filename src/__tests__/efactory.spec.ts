...
describe('EFactory Tests', () => {
  ...
  describe('Factory and Package Relationships', () => {
    ...
    it('should handle factory lookup via package registry', () => {
      if (typeof EPackage !== 'undefined' && typeof EPackage.Registry !== 'undefined') {
        const foundCoreFactory = EPackage.Registry.INSTANCE.getEFactory(corePackage.getNsURI());
        const foundAnalysisFactory = EPackage.Registry.INSTANCE.getEFactory(analysisPackage.getNsURI());
