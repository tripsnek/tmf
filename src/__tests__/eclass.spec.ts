...
beforeEach(() => {
  ...
  const testBarSpecialization =
    CoreFactory.eINSTANCE.createBarSpecializationWithComponents();
...
describe('EClass Tests', () => {
  ...
  describe('Structural Features', () => {
    ...
    it('should return all structural features including inherited ones', () => {
      ...
      expect(fooAllFeatures.size()).toBeGreaterThan(
        fooClass.getEStructuralFeatures().size()
      );
  ...
  describe('Attributes', () => {
    ...
    it('should return all attributes including inherited ones', () => {
      ...
      expect(userAllAttributes.size()).toBeGreaterThan(
        userClass.getEAttributes().size()
      );
  ...
  describe('References', () => {
    ...
    it('should return all references including inherited ones', () => {
      ...
      expect(fooAllReferences.size()).toBeGreaterThanOrEqual(
        fooClass.getEReferences().size()
      );
  ...
  describe('Operations', () => {
    ...
    it('should handle operations with parameters correctly', () => {
      ...
      const opWithParams = barOperations.find(
        (op) => op.getName() === 'doSomethingWithFooAndBazzles'
      );
  ...
  describe('Edge Cases and Error Handling', () => {
    ...
    it('should handle invalid feature lookups', () => {
      expect(
        fooClass.getEStructuralFeature('invalidFeatureName')
      ).toBeUndefined();
